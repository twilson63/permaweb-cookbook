...
The cookbook assumes you have some familiarity with programming, but it isn't a hard requirement.
...
The first section of the cookbook is focused on the [core protocol](../protocol/index.md). This section explains the base layer which developers will build applications on top of, and aims to answer the whats and the whys of Arweave.
