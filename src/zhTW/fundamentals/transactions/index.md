...
Arweave 提供多種發佈交易的方式 — 一般可歸類為直接發佈到 [閘道](../gateways/index.md), 使用 [打包器](./bundles.md), 或者派送交易（dispatch）。
...
使用 `arweave-js` 直接發佈交易的範例可以在[在此指南](../../guides/posting-transactions/arweave-js.md)中找到。
