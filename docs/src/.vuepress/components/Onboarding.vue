    ...
    <div class="row hero">
      <div class="col-12 col-md-6 col-lg-5 order-2 order-md-1">
        <div class="hero-text">
          ...
          <RouterLink class="hero-body-text" to="/getting-started/">
            Get Started
          </RouterLink>
        </div>
    ...
    <div class="row cards">
      ...
      <div class="col-12 col-md-6 col-xl-3">
        ...
        >
          ...
          <span style="color: #397bc5" class="body-text card-action"
            >Let's Go</span
          >
        </RouterLink>
      </div>
      ...
      <div class="col-12 col-md-6 col-xl-3">
        <RouterLink to="/concepts" class="onboard-card">
          ...
          <span style="color: #ddb44a" class="body-text card-action"
            >Get Started</span
          >
        </RouterLink>
      </div>
      ...
      <div class="col-12 col-md-6 col-xl-3">
        <RouterLink to="/guides" class="onboard-card">
          ...
          <span style="color: #3da36b" class="body-text card-action"
            >Get Started</span
          >
        </RouterLink>
      </div>
      ...
      <div class="col-12 col-md-6 col-xl-3">
        ...
        >
          ...
          <span style="color: #ab54d3" class="body-text card-action"
