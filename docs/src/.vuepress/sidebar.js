        ...
        children: [
          {
            ...
            link: get_i18n_link(
              langCode,
              "/guides/posting-transactions/arweave-js.html"
            ),
          },
          {
            text: "dispatch",
            link: get_i18n_link(
              langCode,
              "/guides/posting-transactions/dispatch.html"
            ),
          },
          {
            text: "arseeding-js",
            link: get_i18n_link(
              langCode,
              "/guides/posting-transactions/arseeding-js.html"
            ),
          },
          {
            text: "Turbo-SDK",
            link: get_i18n_link(
              langCode,
              "/guides/posting-transactions/turbo.html"
            ),
          },
        ],
      },
        ...
        children: [
          {
            ...
            link: get_i18n_link(
              langCode,
              "/concepts/permawebApplications.html"
            ),
          },
          {
  ...
  },
  {
    ...
    children: [
        ...
        children: [
          {
            ...
            link: get_i18n_link(
              langCode,
              "/guides/dns-integration/server-side.html"
            ),
          },
        ],
      },
	  {
		text: get_i18n_str(langCode, "guides-fetching-arweave-data"),
		link: get_i18n_link(langCode, "/guides/fetching-data/index.html"),
		collapsible: true,
		children: [
			{
				text: "HTTP API",
				link: get_i18n_link(langCode, "/guides/fetching-data/http-api.html"),
			},
			{
				text: "Arweave.js",
				link: get_i18n_link(langCode, "/guides/fetching-data/arweave-js.html"),
			},
			{
				text: "ARIO Wayfinder",
				link: get_i18n_link(langCode, "/guides/fetching-data/wayfinder.html"),
			},
		],
	  },
      {
        ...
        children: [
          ...
          },
          {
            ...
            link: get_i18n_link(
              langCode,
              "/guides/deployment/github-action.html"
            ),
          },
        ],
      },
      {
        ...
        link: get_i18n_link(
          langCode,
          "/guides/deploying-manifests/deployingManifests.html"
        ),
        collapsible: true,
        children: [
          {
            ...
            link: get_i18n_link(
              langCode,
              "/guides/deploying-manifests/arweave-app.html"
            ),
          },
          {
            text: "ardrive",
            link: get_i18n_link(
              langCode,
              "/guides/deploying-manifests/ardrive.html"
            ),
          },
          {
            text: "arseeding-js",
            link: get_i18n_link(
              langCode,
              "/guides/deploying-manifests/arseeding-js.html"
            ),
          },
          {
            text: "Turbo",
      ...
      },
      {
        ...
        link: get_i18n_link(
          langCode,
          "/guides/querying-arweave/queryingArweave.html"
        ),
        collapsible: true,
        children: [
          {
            ...
            link: get_i18n_link(
              langCode,
              "/guides/querying-arweave/ar-gql.html"
            ),
          },
          {
            ...
            link: get_i18n_link(
              langCode,
              "/guides/querying-arweave/search-indexing-service.html"
            ),
          },
        ],
      },
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            link: get_i18n_link(
              langCode,
              "/concepts/arfs/schema-diagrams.html"
            ),
          },
        ],
      },
            ...
            children: [
              {
                ...
                link: get_i18n_link(
                  langCode,
                  "/guides/atomic-tokens/intro.html"
                ),
              },
              {
                text: "Warp",
                ...
                children: [
                  {
                    ...
                    link: get_i18n_link(
                      langCode,
                      "/guides/smartweave/warp/intro.html"
                    ),
                  },
                  {
                    text: get_i18n_str(
                      langCode,
                      "guides-warp-deploying-contracts"
                    ),
                    link: get_i18n_link(
                      langCode,
                      "/guides/smartweave/warp/deploying-contracts.html"
                    ),
                  },
                  {
                    ...
                    link: get_i18n_link(
                      langCode,
                      "/guides/smartweave/warp/readstate.html"
                    ),
                  },
                  {
                    text: get_i18n_str(
                      langCode,
                      "guides-warp-write-interactions"
                    ),
                    link: get_i18n_link(
                      langCode,
                      "/guides/smartweave/warp/write-interactions.html"
                    ),
                  },
                  {
                    ...
                    link: get_i18n_link(
                      langCode,
                      "/guides/smartweave/warp/evolve.html"
                    ),
                  },
                ],
              },
