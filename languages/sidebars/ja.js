module.exports = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        text: "クエリ",
        link: "/ja/concepts/query-transactions.html",
      },
      {
        text: "データの取得",
        ...
        children: [
          {
            ...
            link: "/ja/concepts/permaweb-applications.html",
          },
          {
            text: "ゲートウェイ",
  ...
  },
  {
    ...
    children: [
      ...
      {
        text: "マニフェストのデプロイ",
        link: "/ja/guides/deploying-manifests/deploying-manifests.html",
        collapsible: false,
        children: [
          {
            text: "arweave.app",
      ...
      {
        text: "GraphQL",
        link: "/ja/guides/querying-arweave/querying-arweave.html",
        collapsible: false,
        children: [
          {
            text: "ArDB",
        ...
        children: [
          {
            ...
            link: "/ja/kits/react/create-react-app.html",
          },
          {
            text: "Vite",
            link: "/ja/kits/react/vite.html",
          },
        ],
      },
      {
        ...
        children: [
          {
            text: "Minimal",
            link: "/ja/kits/svelte/minimal.html",
          },
          {
            text: "Vite",
